...
@section('content')
    <div class="row d-flex justify-content-center">
        <div class="col-8">
            <form action="{{ route('admin.mycourse.quiz.store', $course->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <x-card class="p-4" title="Quiz">
                    ...
                    @endforeach
                    <a href="{{ route('admin.mycourse') }}" class="btn btn-danger btn-sm mr-1">
