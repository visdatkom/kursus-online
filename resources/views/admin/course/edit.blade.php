    ...
    <div class="row d-flex justify-content-center">
        <div class="col-10">
            <form action="{{ route('admin.course.update', $course->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <x-card-form title="EDIT KURSUS" url="{{ route('admin.course.index') }}" titleBtn="Update Kursus">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <x-input title="Demo" type="text" name="demo" placeholder="Masukkan url demo kursus"
                                    value="{{ $course->demo }}" />
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <x-upload-file title="Sampul" name="image" value="{{ $course->image }}" />
