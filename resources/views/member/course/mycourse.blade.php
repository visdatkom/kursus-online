                            ...
                            <div class="col-md-9 mb-3 text-dark">
                                ...
                                <div class="d-none d-md-block d-lg-block mt-3">
                                    ...
                                    @if($data->course->quizes)
                                        <a href="{{ route('member.mycourse.quiz', $data->course->id) }}" class="btn btn-success btn-md mb-2">
                                    ...
                                    @if($canPrintCertificate)
                                        <a href="{{ route('member.mycourse.certificate', $data->course->id) }}" target="_blank" class="btn btn-info btn-md mb-2">
