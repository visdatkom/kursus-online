...
class MyCourseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        */
        ...
        return view('member.course.mycourse', compact('courses', 'score'));
    }
    ...
    public function quiz($id)
    {
        ...
        if($quiz)
            return view('member.course.quiz', compact('course', 'quiz', 'quizAttempt'));
        else
    ...
    public function quizStore(Request $request, $id)
    {
        ...
        return redirect()->route('member.mycourse')->with('toast_success', 'Quiz telah disimpan!');
    }
